...
if (typeof firebase !== 'undefined') {
  ...
  console.error("Firebase SDK failed to load. Please check your internet connection or script tags.");
}
...
document.getElementById('native-camera').addEventListener('change', (event) => {
  if (event.target.files[0]) {
    ...
    // In a Google Apps Script production environment, you would convert this file 
    // to base64 and pass it to google.script.run.saveTimeLog().
